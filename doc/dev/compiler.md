...
3. Interpret the AST to generate the final HTML output. Note that the short code and include commands
    will bring new templates into current template, we should do step 2 and 3 recursively until all templates
...
tree of all templates and save all immediate files during compilation. When a file changes, we can
